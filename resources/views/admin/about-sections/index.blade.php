...
@section('breadcrumbs')
    <x-ui.breadcrumbs :items="[['label' => 'Dashboard', 'url' => route('admin.dashboard')], ['label' => 'About Us']]" />
@endsection
...
@section('content')
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div class="flex flex-wrap gap-3">
            <x-ui.button href="{{ route('admin.org-profile.edit') }}" variant="secondary">Registration & Certificates</x-ui.button>
            <x-ui.button href="{{ route('admin.pages.seo.edit', 'about') }}" variant="secondary">About Page SEO</x-ui.button>
            <x-ui.button href="{{ route('about') }}" target="_blank" variant="ghost">Preview About Page</x-ui.button>
        </div>
    </div>
    ...
    <ul
        x-data="{
            ...
            async saveOrder() {
                ...
                await fetch('{{ route('admin.about-sections.reorder') }}', {
                    method: 'POST',
                    headers: {
    ...
    >
        @foreach ($sections as $section)
            ...
            >
                ...
                <div class="flex items-center gap-3">
                    <form method="POST" action="{{ route('admin.about-sections.toggle', $section) }}">
                        @csrf
                        @method('PATCH')
                    ...
                    <a href="{{ route('admin.about-sections.edit', $section) }}" class="text-sm font-medium text-primary-700 hover:underline dark:text-night-text">
                        Edit
                    </a>
                </div>
            </li>
