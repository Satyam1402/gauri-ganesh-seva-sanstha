...
@include('admin.partials.seo-fields', [
    'seo' => $post?->seo,
    'model' => $post,
    'previewTitle' => old('title', $post->title ?? 'Post title'),
    'previewDescription' => old('excerpt', $post->excerpt ?? ''),
    'previewUrl' => $post ? route('blog.show', $post) : url('/blog/…'),
    'previewImage' => $post?->getFirstMedia('featured_image')?->getUrl(),
