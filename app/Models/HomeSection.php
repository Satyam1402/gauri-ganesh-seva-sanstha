...
class HomeSection extends Model implements HasMedia
{
    ...
    {
        return $this->hasMany(HomeSectionButton::class)->orderBy('order_column');
    }

    public function items(): HasMany
    {
        return $this->hasMany(HomeSectionItem::class)->orderBy('order_column');
    }
